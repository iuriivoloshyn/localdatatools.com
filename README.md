...
- **Smart CSV Editor** — Natural language instructions (local Gemma 4 E2B AI) to clean and transform data.
...
- **AI Chat** — Gemma 4 E2B LLM running locally via WebGPU (MediaPipe tasks-genai).
...
- **AI/ML**: MediaPipe (@mediapipe/tasks-genai), Tesseract.js
- **Data**: SheetJS (XLSX), PDF.js, Mammoth.js
- **Media**: FFmpeg WebAssembly (@ffmpeg/ffmpeg)
- **Infra**: Vercel (frontend), Cloudflare R2 (model hosting)
