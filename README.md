...
### API
RESTful API for server-side processing. Endpoints for CSV merge/join/diff/anonymize, file conversion (spreadsheet, image, document, audio), and compression. Supports files up to 1GB via encrypted R2 storage.

See [API docs](https://localdatatools.com) (API Docs section).
